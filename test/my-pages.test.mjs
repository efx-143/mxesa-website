...
/* The OAuth hop page. MyMLH's registered redirect URI is
   mxesa.in/oauth/mlh/callback, and no platform rule forwards
...
const WIRING = [
  ...
  },
  {
    ...
    why: 'the hero greets "your MXESA" on both sides of the Preptember flag — the month-naming preptemberAccent swap retired 2026-08-18, and its return would rename the hub for one side of the flag.',
  },
  {
    file: 'src/pages/my.js',
    token: 'endSession()',
