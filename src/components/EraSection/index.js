  ...
  <EraRoot id="new-era">
    <SectionHeading>
      <div>
        ...
        <EraHeading>
          MXESA becomes something you <em>attend.</em>
        </EraHeading>
      </div>
      <SectionCopy>
        <p>
          When MXESA started, open source had a contributor problem. Projects
          needed people, and a simple pull-request challenge brought millions of
          them in.
        </p>
        <p>
        ...
        <ThesisLine>
          So this year, MXESA is hundreds of in-person Fests plus a global
          online event, all about building with open source AI.
        </ThesisLine>
      </SectionCopy>
    </SectionHeading>

    <EraShift aria-label="How MXESA is changing">
      {PANELS.map((panel) => (
