...
/* The strip above the nav, on every page. Preptember's one ask, in the
   ...
   Preptember in the middle of MXESA. */


export const hero = {
  eyebrow: ['EST. 2026 • DEPARTMENT OF MECHATRONICS • MMIT PUNE'],
  heading: { lead: 'MXESA 2026:', accent: 'Innovation belongs to everyone.' },
  deck: 'Bring the future of automation to life. The founding student association bridging mechanics, electronics, and code. Join our community of second-year builders and seniors to experiment, build cyber-physical systems, and push technical boundaries. Hardware and software, unified.',
  cta: 'Explore Upcoming Events',
  secondaryCta: 'Meet the Core Team',
  poweredByLabel: 'Powered by Mechatronics MMIT',
  presentingLabel: 'Presenting partner',
};

export const timeline = {
  eyebrow: 'Upcoming Events',
  heading: { lead: 'System Online:', accent: 'Upcoming Operations.' },
  intro:
...
export const mission = {
  ...
  heading: { lead: 'Pioneering the', accent: 'Mechatronics Culture.' },
  paragraphs: [
    [
      {
        text: "Established in the Academic Year 2026-27, the Mechatronics Engineering Student's Association (MXESA) is the premier platform for students at Marathwada Mitramandal's Institute of Technology. We provide the ecosystem to develop leadership, hands-on organizational skills, and technical excellence.",
      },
    ],
    [{ text: 'Under the guidance of:', bold: true }],
    [{ text: 'Prof. Shital Khande (Faculty Coordinator)' }],
    [{ text: 'Dr. Yogini Borole (Faculty Coordinator)' }],
  ],
};

export const getInvolved = {
  eyebrow: 'The Core Committee',
  heading: { lead: 'The Founding', accent: 'Committee' },
  intro:
    "Meet the student leaders driving the MXESA vision. These are the founding members of the Mechatronics Engineering Student's Association at MMIT Pune.",
  cards: [
    {
      id: 'president',
      tag: 'President',
    ...
    },
    {
      id: 'treasurer',
      tag: 'Treasurer',
      title: 'Chitranjan Bhalerao',
      copy: [],
      cta: 'View Profile',
    },
    {
      id: 'tnp',
      tag: 'Training & Placement / Alumni Coordinator',
      title: 'Yojit Giri',
      copy: [],
      cta: 'View Profile',
    },
...
export const faq = {
  ...
  intro:
    'MXESA works differently this year, and a new format always comes with questions. We have the answers: here’s what to know about hosting a Fest, taking part, and what comes next.',
  sections: [
  ...
  items: [
    // -- General & Mission Overview --------------------------------------
    {
      id: 'what-is-mxesa',
      section: 'general',
      question: 'What is MXESA?',
      answer: [
        {
          text: 'MXESA is a global celebration of open source that runs throughout October. This year, MXESA is run by ',
        },
    ...
    },
    {
      id: 'how-2026-differs',
      section: 'general',
      question: 'How is MXESA 2026 different from previous years?',
      answer: [
        {
          text: 'MXESA 2026 will feature 300+ in-person and online community events worldwide focused on hands-on building, experimentation, and learning with open-source AI and open-weight models. In previous years, MXESA focused on counting individual contributions to open-source projects.',
        },
      ],
    },
    {
      ...
      section: 'general',
      question: 'Why is MXESA 2026 focused on open-source AI?',
      answer: [
        {
    ...
    },
    {
      ...
      answer: [
        {
          text: 'Open source runs 365 days a year, and you can get started anytime. Just because MXESA isn’t incentivizing open source contributions with swag doesn’t mean you can’t contribute any more. Check out ',
        },
        {
          text: 'this guide',
    ...
    },
    {
      ...
      section: 'general',
      question: 'Why is MXESA moving away from counting Pull Requests (PRs)?',
      answer: [
        {
          text: 'With the rise of AI tools making low-effort PRs trivial to generate, open-source maintainers faced unprecedented floods of noise, spam, and burnout. In 2026, MXESA is refocusing on high-value, meaningful learning, collaborative events, and open-source AI development rather than raw PR volume.',
        },
      ],
    },
    {
    ...
    // -- In-Person Events (“Fests”) & Formats ------------------------------
    {
      ...
      answer: [
        {
          text: 'A Fest is an official, in-person MXESA event lasting up to 12 hours, designed to bring local developer communities together to learn and build with open-source AI.',
        },
      ],
    },
    {
      ...
      answer: [
        {
          markdown:
            '1. **MXESA Hack Day:** Structured mini hackathons where participants build open-source AI projects during the event. Features official swag, prize categories, DEV Badges, potential partner prizes, and food/beverage reimbursement for organizers.\n2. **MXESA Meet Up:** Flexible, informal community gatherings (talks, workshops, panels, or social discussions) centered around open-source AI. Receives official swag (stickers, T-shirts, postcards) but no prizes or food/beverage reimbursement.',
        },
      ],
    },
    {
      ...
      answer: [
        {
          text: 'While we are committed to sending thousands of T-shirts to in-person events, we cannot guarantee a T-shirt to every MXESA participant. The T-shirts we send to each event are distributed by local organizers to participants as on-site availability allows and at their discretion. We unfortunately cannot promise to mail T-shirts to in-person participants who did not receive one at their events due to logistical constraints. Online MXESA participants will not be eligible for a T-shirt.',
        },
      ],
    },
    {
    ...
    // -- Fest Hosting, Applications & Logistics ----------------------------
    {
      ...
      answer: [
        { text: 'Organizers can apply via the ' },
        {
          ...
          text: 'host portal',
          href: 'https://organize.mlh.com/host/mxesa-2026',
        },
        { text: '. Visit our ' },
        {
          text: 'organizer guide',
          href: 'https://mlh.gitbook.io/mlh-mxesa-organizer-guide',
        },
    ...
    },
    {
      ...
      answer: [
        {
          text: 'Participants who cannot attend an in-person Fest can earn an official MXESA Swag Envelope by completing participation milestones online (more details soon on these milestones).',
        },
      ],
    },
    {
      ...
      answer: [
        {
          text: 'Custom MXESA stickers and other envelope-friendly items.',
        },
      ],
    },
    {
      ...
      answer: [
        {
          text: 'Envelope shipments will begin dispatching after MXESA concludes and should arrive at most destinations within 30-60 days.',
        },
      ],
    },
    {
      ...
      answer: [
        {
          text: 'Reimbursements apply strictly to MXESA Hack Day events for approved in-policy food and beverage expenses up to a designated cap. Meet Ups and corporate partner hosts are not eligible for reimbursement.',
        },
      ],
    },
    // -- Sponsorship & Partner Packages -------------------------------------
    {
      id: 'how-to-sponsor',
      section: 'sponsorship',
      question: 'How can companies sponsor MXESA 2026?',
      answer: [
        {
          text: 'Companies can reach out to discuss sponsorship opportunities with our team at ',
        },
        { text: 'mxesa@mlh.io', href: 'mailto:mxesa@mlh.io' },
        { text: '.' },
      ],
    },
  ],
  ...
  page: {
    title: 'FAQ | MXESA 2026',
    description:
      'Answers to the most common MXESA 2026 questions: the mission change, Preptember, Fest formats, hosting logistics, swag, and sponsorship.',
    eyebrow: 'Common questions',
    heading: { lead: 'Everything you need', accent: 'to know.' },
    intro:
      'MXESA works differently this year, and a new format always comes with questions. Here is what to know about hosting a Fest, taking part, and what comes next.',
  },
};
...
export const subscribed = {
  title: 'Thanks for signing up | MXESA 2026',
  eyebrow: 'You’re on the list',
  heading: { lead: 'Thanks for being', accent: 'part of it.' },
  body: 'We’ll be in touch about MXESA 2026 as soon as there’s news to share.',
  cta: 'Back to MXESA',
};
...
export const signedOut = {
  title: 'Signed out | MXESA 2026',
  eyebrow: 'See you soon',
  heading: { lead: 'You’re', accent: 'signed out.' },
  body: 'You’re signed out of MXESA on this device.',
  mlh: {
...
export const fests = {
  title: 'Find a Fest | MXESA 2026',
  description:
    'Search MXESA 2026 Fests by name, city, or country, or find the one nearest you on the map.',
  eyebrow: 'The Fests',
  ...
  /* The two Fest formats, badged on the card and in the modal. Read out of
     ...
     "hackathon" for every MXESA event there is — see
...
/* Copy for /host, the organizer-facing page. A Fest is one of two formats:
   ...
   substance. */
export const host = {
  title: 'Host a Fest | MXESA 2026',
  description:
    'Bring MXESA to your city. Host a one-day, in-person Hack Day or Meet Up about open source AI. Compare the formats, see the support organizers get, and apply to host.',
  eyebrow: 'Host a Fest',
  heading: { lead: 'Bring MXESA', accent: 'to your city.' },
...
export const sponsor = {
  title: 'Sponsor MXESA | MXESA 2026',
  description:
    'Partner with MXESA 2026 and put your brand alongside the models, tools, and communities bringing open source AI to builders at 300+ Fests worldwide.',
  eyebrow: 'Sponsors',
    ...
    benefits: [
      {
        ...
        copy: 'Recognition on the MXESA website, in-person Fest slides, and key campaign communications.',
      },
      {
        id: 'envelopes',
...
export const notFound = {
  title: 'Page not found | MXESA 2026',
  eyebrow: 'Error 404',
  heading: { lead: 'This page', accent: 'doesn’t exist.' },
  body: 'The link may be broken, or the page may have moved. Everything about MXESA 2026 is back on the homepage.',
  cta: 'Back to MXESA',
};
...
export const my = {
  ...
  welcome: {
    ...
    /* One accent on both sides of the Preptember flag — the hub is "your
       MXESA" whichever month it's living in. The month-naming
       preptemberAccent swap retired 2026-08-18. */
    accent: 'welcome to your MXESA.',
  },
  ...
  acknowledgements: {
    ...
    opening: {
      ...
      body: (name) =>
        `You applied, you were approved, you published. Four quick confirmations and ${name} heads to mxesa.in.`,
      cta: 'Let’s go',
    },
    ...
    checks: {
      ...
      failures: {
        ...
        name: 'Your Fest has been renamed. Its name needs to read \u201cMXESA Hack Day <City>\u201d or \u201cMXESA Meetup <City>\u201d, optionally followed by \u201c x <Partner>\u201d, joining multiple partners with \u201c&\u201d.',
        duration:
      ...
      warningBody:
        'Please email the MXESA team and we\u2019ll help get your Fest live as quickly as possible.',
      ...
      email: 'mxesa@mlh.io',
      emailCta: 'Email mxesa@mlh.io',
      close: 'Close',
    },
    title: 'Final acknowledgements',
    intro: (name) => `Confirm these to put ${name} on mxesa.in.`,
    ...
    success: {
      ...
      body: (name) =>
        `${name} is now live on mxesa.in. It can take up to five minutes to become publicly visible.`,
      done: 'Done',
    },
    ...
    /* The venue slide's guidance: what the map is, and what to do when it
       ...
       link. */
    venueCheck: {
      intro: 'Your venue, exactly as it will appear on mxesa.in.',
      wrongLead: 'Wrong address or pin? Email ',
      wrongEmail: 'mxesa@mlh.io',
  ...
  /* The host resources band, under Your Applications. The handbook and
     ...
     MXESA team are in #mxesa-2026, ready for your
     ...
     promoting your Fest under the MXESA name") is hidden for now:
  ...
  hostResources: {
    ...
    items: [
      ...
      },
      {
        ...
        copy: 'Send your questions to mxesa@mlh.io and the MXESA team will pick them up.',
        cta: 'Send an email',
      },
    ],
  },
  ...
  thankYou: {
    ...
    cardLabel: 'Postcard from the MXESA team. Flip to read the note',
    flipHint: 'flip me →',
    ...
    note: {
      ...
      signature: 'The MXESA Applications Team: Stephen, Jacklyn & Quinn',
    },
  },
  ...
  error: {
    title: 'We couldn’t load your MXESA',
  ...
  /* The whole-page MLH outage state. Deliberately blames nothing on the
     ...
     worse than none. MXESA runs on MyMLH, so naming it plainly is
     more useful than a generic outage line. */
  mlhDown: {
    eyebrow: 'Your MXESA',
    title: 'MyMLH is unreachable',
    accent: 'Try again shortly.',
    body: 'MXESA runs on MyMLH, and we can’t reach it right now. Nothing is wrong with your account or your progress, so please check back in a few minutes.',
  },
  loading: 'Loading your MXESA…',
};
...
const sessionBlocked = {
  ...
  body: 'Your browser is blocking cookies and site data for mxesa.in, and signing in needs them. Allow them for this site, then try again.',
...
export const authError = {
  title: 'Sign-in error | MXESA 2026',
  eyebrow: 'Your MXESA',
...
export const authCallback = {
  title: 'Signing you in | MXESA 2026',
  eyebrow: 'Your MXESA',
  working: {
  ...
  noEmail: {
    ...
    body: 'Your sign-in worked, but we can’t set up your MXESA without an email address to reach you on. Add one to your MyMLH profile, then sign in again.',
