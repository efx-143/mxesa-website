...
const main = async () => {
  ...
  /* Never fatal, and this is the whole lesson of Aug 21, 2026.
     ...
     That turned a cache check into a trap. mxesa.in is served by
     two App Platform apps, mxesa-production-nyc and
     mxesa-production-sfo, and they build separately. One built
