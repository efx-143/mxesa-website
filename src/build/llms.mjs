...
const START_HERE = [
  {
    route: '/',
    text: '[MXESA 2026](./): The event overview, the mission, and how to get involved.',
  },
  {
    route: '/fests/',
  ...
  {
    route: '/sponsor/',
    text: '[Sponsor MXESA](./sponsor/): The confirmed sponsor wall, the campaign footprint, and what a partnership carries.',
  },
  {
    route: '/questions/',
