...
export const SESSION_STORAGE_KEY = 'mxesa.session';
export const RETURN_TO_STORAGE_KEY = 'mxesa.returnTo';
...
export const EXPERIENCE_CACHE_KEY = 'mxesa.experience';
...
/* Where the OAuth hop page (/oauth/mlh/callback/) sends the browser on.
   ...
   MyMLH's OAuth app registers mxesa.in/oauth/mlh/callback as its
