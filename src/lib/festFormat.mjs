/* A Fest's format, read out of its name.
   ...
   MXESA event in /api/events returns "hackathon", MLH's generic
   event type, including the record named "Quinn's non-hack day
   mxesa test". The two Fest formats live in the naming convention
...
/* Word-bounded so the site's own name never badges itself: "MXESA"
