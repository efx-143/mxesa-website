/* A Fest's name splits into the Fest and whoever is hosting it.
     ...
     MXESA Meet Up Toronto x Hack the 6ix
     └──────── title ───────────┘   └─ hostedBy ┘
...
/* The card's heading. Cards led with "MXESA" on every one of them,
   on mxesa.in, on the Find a Fest page — and then repeated the
   format that the badge directly above already carried. Of four words in
   "MXESA Hack Day Brooklyn", one told you which Fest it was.

   So the front of the name comes off and the rest becomes the heading.
   Only the front: a name that merely mentions MXESA somewhere else
